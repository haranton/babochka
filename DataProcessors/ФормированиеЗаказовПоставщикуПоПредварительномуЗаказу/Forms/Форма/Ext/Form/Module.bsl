...
Процедура ЗаписатьЗаказНаСервере(ДокументОбъект, СкладРодитель, СписокОшибок)
	...
	Если НЕ РазбиватьЗаказыПоСкладам 
		...
		//НайденныеСтроки = ДокументОбъект.ТоварныеКатегории.НайтиСтроки(Новый Структура("Склад", ДокументОбъект.Склад));
		//Если НайденныеСтроки.Количество() < ДокументОбъект.ТоварныеКатегории.Количество() Тогда
	...
	Если НЕ РазбиватьЗаказыПоДатамПоставки Тогда
		//НайденныеСтроки = ДокументОбъект.ТоварныеКатегории.НайтиСтроки(Новый Структура("ДатаПоступления", ДокументОбъект.ДатаПоступления));
		//Если НайденныеСтроки.Количество() = ДокументОбъект.ТоварныеКатегории.Количество() Тогда
			ДокументОбъект.ПоступлениеОднойДатой = Истина;
		//КонецЕсли; 
	КонецЕсли; 
	...
	Если ЗначениеЗаполнено(ДокументОбъект.Склад) Тогда
		...
		//СкладыСервер.ЗаполнитьСкладыВТабличнойЧасти(ДокументОбъект.Склад, СкладГруппа, ДокументОбъект.ТоварныеКатегории, Ложь);
	КонецЕсли;
