...
Процедура ba_ЗаполнитьДокументНаОснованииЗаказаКлиента(Знач ДокументОснование, Знач СкладОтгрузки, ВариантОформления, РеквизитыЗаказа, ПараметрыОформления, ХозяйственнаяОперацияРеализации)
	...
	для каждого стр из товары цикл
		...
		//маркировка
		//Ювелирные изделия	хаа_вопрос
		//Если НоменклатураВСтроке.ВидНоменклатуры.ЭтоЮвелирнаяПродукция Тогда
		//	
		//	СерияНоменклатуры = Комтет.НайтиСериюНоменклатуры(ЗаказКлиента, НоменклатураВСтроке, стр.Характеристика, МассивШтрихкодовУпаковок);
		...
		//		НоваяСтрока.Номенклатура 	= НоменклатураВСтроке;
