...
Процедура УстановитьПараметрыСтруктурыДействийПриПоискеПоШтрихкоду(СтруктураДействий, ХозяйственнаяОперация)
	...
	Если Не НоменклатураСервер.СписокХозяйственныхОперацийИсключающихУслугиИРаботы().НайтиПоЗначению(ХозяйственнаяОперация) = Неопределено Тогда
		СтруктураДействий.ТолькоТовары = Истина;
	ИначеЕсли Не НоменклатураСервер.СписокХозяйственныхОперацийИсключающихРаботы().НайтиПоЗначению(ХозяйственнаяОперация) = Неопределено Тогда
...
Процедура КонтрольНеСогласованныхИзмененийОбработатьСобытиеПриИзменении(Элемент)
	...
	ИначеЕсли Элемент.Имя = "ТоварыЦенаИнвойс" Тогда
		ТоварыЦенаИнвойсПриИзменении(Элемент);
	ИначеЕсли Элемент.Имя = "ТоварыСуммаИнвойс" Тогда
		ТоварыСуммаИнвойсПриИзменении(Элемент);
	Иначе
...
Процедура ТоварныеКатегорииПриИзменении(Элемент)
	...
	Для Каждого СтрокаКатегорий Из Объект.ТоварныеКатегории Цикл
		...
		ПоискПоКатегории = Новый Структура("ТоварнаяКатегория", СтрокаКатегорий.ТоварнаяКатегория);
		ДанныеВТоварах = ТоварныеКатегорииТоваров.НайтиСтроки(ПоискПоКатегории);
...
&НаКлиенте
Процедура ТоварныеКатегорииЦенаПриИзменении(Элемент)
	...
	ТекущаяСтрока.СуммаИнвойс = ТекущаяСтрока.ЦенаИнвойс * ТекущаяСтрока.Количество - ТекущаяСтрока.СуммаРучнойСкидки;
...
&НаКлиенте
Процедура ТоварныеКатегорииПроцентРучнойСкидкиПриИзменении(Элемент)
	...
	Объект.ПроцентРучнойСкидки = ТекущаяСтрока.ПроцентРучнойСкидки;
	ТекущаяСтрока.СуммаРучнойСкидки = ТекущаяСтрока.СуммаБезСкидки * ТекущаяСтрока.ПроцентРучнойСкидки / 100;
	ТекущаяСтрока.СуммаИнвойс = ТекущаяСтрока.СуммаБезСкидки - ТекущаяСтрока.СуммаРучнойСкидки;
	ТекущаяСтрока.ЦенаИнвойс = ?(ТекущаяСтрока.Количество = 0, 0, ТекущаяСтрока.СуммаИнвойс / ТекущаяСтрока.Количество);
...
&НаКлиенте
Процедура ТоварныеКатегорииСуммаРучнойСкидкиПриИзменении(Элемент)
...
&НаКлиенте
Процедура ТоварныеКатегорииСуммаПриИзменении(Элемент)
...
&НаКлиенте
Процедура ТоварныеКатегорииПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)

	ТекущаяСтрока = Элемент.ТекущиеДанные;

	ТекущаяСтрока.СтавкаНДС = ПредопределенноеЗначение("Справочник.СтавкиНДС.БезНДС");
	ТекущаяСтрока.ПроцентРучнойСкидки = Объект.ПроцентРучнойСкидки;

КонецПроцедуры

&НаКлиенте
Процедура ТоварныеКатегорииСуммаБезСкидкиПриИзменении(Элемент)
...
&НаКлиенте
Процедура ТоварыЦенаИнвойсПриИзменении(Элемент)
...
&НаКлиенте
Процедура ТоварыСуммаИнвойсПриИзменении(Элемент)
